    ...
    <body>
        <div id="wrapper">
            ...
            <nav>
                <div id="menuItems">
                    <ul>
                        <li><a href="index-Jiawei Guo.php">Home</a></li>
                        <li><a href="menu-Jiawei Guo.php">Menu</a></li>
                        <li><a href="contact-Jiawei Guo.php">Contact</a></li>
...
<?php
   class MenuItem{
	   ...
	   function __construct($itemName, $discription, $price)
	   {
